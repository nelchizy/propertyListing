...
<!-- Mirrored from steelthemes.com/demo/html/real-estate/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2018 15:51:10 GMT -->
<head>
		<meta charset="UTF-8">
    ...
    <div class="boxed_wrapper">
		...
		<!-- About us history ____________________________ -->

		<div class="about_history container">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-6 history_item">
					<div class="content">
						<div class="img_holder">
							<img src="images/about-us/1.jpg" alt="image" class="img-responsive tran3s">					
						</div>
						<h6>first established - 1984 </h6>
					</div> <!-- End .content -->
				</div> <!-- End .history_item -->

				<div class="col-lg-3 col-md-3 col-sm-6 history_item">
					<div class="content fix_small">
						<div class="img_holder">
							<img src="images/about-us/2.jpg" alt="image" class="img-responsive tran3s">					
						</div>
						<h6>Best Concepts In - 1988</h6>
					</div> <!-- End .content -->
				</div> <!-- End .history_item -->
				...
				<div class="col-lg-3 col-md-3 col-sm-6 history_item">
					<div class="content">
						<div class="img_holder">
							<img src="images/about-us/3.jpg" alt="image" class="img-responsive tran3s">					
						</div>
						<h6>Extended to 48 Offices - 1996</h6>
					</div> <!-- End .content -->
				</div> <!-- End .history_item -->
				...
				<div class="col-lg-3 col-md-3 col-sm-6 history_item">
					<div class="content fix_small">
						<div class="img_holder">
							<img src="images/about-us/4.jpg" alt="image" class="img-responsive tran3s">					
						</div>
						<h6>Top 5 In The World - 2001</h6>
					</div> <!-- End .content -->
				</div> <!-- End .history_item -->
			</div> <!-- End .row -->
		</div> <!-- End .about_history -->


		<!-- End About us history ________________________ -->


		<!-- Some Fun facts_______________________________ -->

		<div class="fun_facts">
			<div class="fun_content">
				
				<div class="container">
					<div class="img_holder img_left">
						<img src="images/about-us/5.jpg" alt="images">
					</div> <!-- End .img_left -->
					...
					<div class="facts_item">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
								<img src="images/about-us/decor.png" alt="decor" class="img-responsive">
								<span><i class="fa fa-building"></i></span>
								<h6>3045 Properties</h6>
							</div>
							<!-- single item -->
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
								<img src="images/about-us/decor.png" alt="decor" class="img-responsive">
								<span><i class="fa fa-shield"></i></span>
								<h6>32 Years Experience</h6>
							</div>
							<!-- single item -->
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
								<img src="images/about-us/decor.png" alt="decor" class="img-responsive">
								<span><i class="fa fa-users"></i></span>
								<h6>4056 Satisfied Clients</h6>
							</div>
							<!-- single item -->
							<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 item">
								<img src="images/about-us/decor.png" alt="decor" class="img-responsive">
					...
					<div class="img_holder img_right">
						<img src="images/about-us/6.jpg" alt="images">
					</div> <!-- End .img_right -->
				</div>
		...
		<!-- End Some Fun facts___________________________ -->



		<!-- Popular Agents Two ______________________________ -->
		
		<section class="popular_agent popular_agent_two container">
			...
			<div class="row agent_people">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 single_agent">

					<div class="agent_image">
						<div class="img_holder">
							<img src="images/home2/14.jpg" alt="agent" class="img-responsive">
						</div> <!-- End .img_holder -->
						<div class="agent_name">
							...
							<div class="button">
								<a href="agent-details.html" class="tran3s"><i class="fa fa-building"></i></a>
								<span class="tran3s"><i>My Listing</i> <i class="fa fa-caret-down"></i></span>
							</div> <!-- End .button -->
							<div class="clear_fix"></div>
						</div> <!-- End .agent_name -->
					</div> <!-- End .agent_image -->
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 single_agent">
					...
					<div class="agent_image">
						<div class="img_holder">
							<img src="images/home2/15.jpg" alt="agent" class="img-responsive">
						</div> <!-- End .img_holder -->
						<div class="agent_name">
							<div class="name_holder">
								<h4>Jem Stone Lawren</h4>
								<i>Real Estate Agent</i>
							</div> <!-- End .name_holder -->
							<div class="button">
								<a href="agent-details.html" class="tran3s"><i class="fa fa-building"></i></a>
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 single_agent">
					...
					<div class="agent_image">
						<div class="img_holder">
							<img src="images/home2/16.jpg" alt="agent" class="img-responsive">
						</div> <!-- End .img_holder -->
						<div class="agent_name">
							<div class="name_holder">
				...
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 single_agent">
					...
					<div class="agent_image">
						<div class="img_holder">
							<img src="images/home2/17.jpg" alt="agent" class="img-responsive">
						</div> <!-- End .img_holder -->
						<div class="agent_name">
							<div class="name_holder">
								<h4>Alex Steinbreacher</h4>
								<i>Real Estate Agent</i>
							</div> <!-- End .name_holder -->
							<div class="button">
								<a href="agent-details.html" class="tran3s"><i class="fa fa-building"></i></a>
					...
					<div class="agent_contact">
						<a href="tel:84521-63-452"><i class="fa fa-phone" style="padding-right:10px;"></i> 84521-63-452</a>
						<a href="mailto:Alexstein@domain.com"><i class="fa fa-envelope-o" style="padding-right:7px;"></i> Alexstein@domain.com</a>
						<ul>
							<li class="tran3s tooltip" title="Facebook"><a href="#"><i class="fa fa-facebook"></i></a></li>
							<li class="tran3s tooltip" title="Twitter"><a href="#"><i class="fa fa-twitter"></i></a></li>
							<li class="tran3s tooltip" title="Google Plus"><a href="#"><i class="fa fa-google-plus"></i></a></li>
		...
		</section> <!-- End .popular_agent_two -->


		<!-- End Popular Agents Two __________________________ -->
		...
		<div class="testimonial_two">
			<div class="container">
				...
				<div class="client_speach">
					<div id="client-slider" class="">
						<div class="item">
							<div class="img_holder">
								<img src="images/home2/13.jpg" alt="client">
								<div class="client_name">
									<h5>Mr.George Anto</h5>
									<span>Client From 2014 Dec 25</span>
								</div> <!-- End .client_name -->
								<div class="clear_fix"></div>
							</div>
							<div class="speach">
								<p>Long established fact that a reader will be undo ut  distracted by the readable sed content off a page when seds looking und at its layouts The sesd points using Lorem  Ipsum is that it has a more-or-less than normal distributionof letter james opposed using content here content here will be making look like readable property developers will be ut distracted by the readable real estate.</p>
							</div> <!-- End .speach -->
							<div class="clear_fix"></div>
						</div> <!-- End .item -->
...
<!-- Mirrored from steelthemes.com/demo/html/real-estate/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2018 15:51:18 GMT -->
</html>