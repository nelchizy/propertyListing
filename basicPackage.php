<?php
   ...
   $freePackage = new PlanSubscription();

   if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['getPlan']) ) {
        $insert = $freePackage->subscribeFree($_POST);
  }
?>
        ...
        <div class="pricing_plan_table container">
            <!-- Main_title__________ -->
                ...
                <p style="margin: 34px 0 33px 0;">This is a free plan</p>
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="single_price_table">
                            <?php
                            $getFree = $package->getFreePackageBasic();
                                if($getFree){
                                while($rows = $getFree->fetch_assoc()){?>
