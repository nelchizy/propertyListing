...
<!-- Mirrored from steelthemes.com/demo/html/real-estate/home-loan.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 14 Feb 2018 15:51:22 GMT -->
<head>
		<meta charset="UTF-8">
	...
	<div class="boxed_wrapper">
		...
		<!-- Home loan Eligibility ________________________ -->

		<div class="home_loan_eligibility container">
			<!-- Main_title__________ -->
			<div class="main_title">
				<h2 style="margin-top:0;">Check Your Loan Eligibility</h2>
			</div>
					...
					<div class="col-lg-2 col-md-2 col-sm-4 col-xs-12">
						<div class="tab_nav_holder">
							 ...
							 <ul class="nav nav-tabs tabs-left"><!-- 'tabs-right' for right tabs -->
							   <li class="active"><a href="#loan" data-toggle="tab" class="tran3s">Loan Eligibility </a></li>
							   <li><a href="#emi" data-toggle="tab" class="tran3s">EMI Option </a></li>
							   <li><a href="#prepayment" data-toggle="tab" class="tran3s">Prepayment</a></li>
							   <li><a href="#rate" data-toggle="tab" class="tran3s">Rate Change</a></li>
							 </ul>
						</div>	<!-- End .tab_nav_holder -->
					</div>

					<div class="col-lg-10 col-md-10 col-sm-8 col-xs-12 tab_details">
						<!-- ___________ tab-content __________ -->
						<div class="tab-content">

							<!-- _____________ loan tab ________________ -->
							<div class="row tab-pane active" id="loan">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="eligibility_form">
										<div class="single_form clear_fix">
											<label>Home Loan Required</label>
											<input type="text" placeholder="15,00,000">
											<div class="clear_fix"></div>
										</div>
										...
										<div class="single_form clear_fix">
											...
											<div class="single_form_select_menu">
										...
										<button class="tran3s clear_fix theme-btn">Check Eligibility</button>
										<div class="clear_fix"></div>

									</form> <!-- End .eligibility_form -->
								</div> <!-- End .col- -->

								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="apply_loan_form">
										<h6><i class="fa fa-check-circle"></i> You Are Eligible For This Loan</h6>

										<label>Loan Value: <span>$15,00,000</span></label>
										<label>EMI Per Month: <span>$19,822</span></label>
										<label>Loan Periods: <span>07/03/2016</span> - <span>07/03/2031</span></label>
										<label>Loan Interest: <span>10% of Your Loan Value</span></label>
										<p>*Interest may be reduce after five years of loan periods.</p>
										<button class="tran3s clear_fix theme-btn">Apply For Loan</button>
										<div class="clear_fix"></div>
									</form> <!-- End .apply_loan_form -->
								</div> <!-- End .col- -->

							</div> <!-- End #loan -->


							<!-- _____________ EMI Option ________________ -->
							<div class="row tab-pane fade" id="emi">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="eligibility_form">
										<div class="single_form clear_fix">
											<label>Home Loan Required</label>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="apply_loan_form">
										<h6><i class="fa fa-check-circle"></i> You Are Eligible For EMI</h6>
							...
							<!-- _____________ Prepayment Option ________________ -->
							<div class="row tab-pane fade" id="prepayment">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="eligibility_form">
										<div class="single_form clear_fix">
											<label>Home Loan Required</label>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="apply_loan_form">
										<h6><i class="fa fa-check-circle"></i> You Are Eligible Prepayment</h6>
							...
							<!-- _____________ Rate Change Option ________________ -->
							<div class="row tab-pane fade" id="rate">
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="eligibility_form">
										<div class="single_form clear_fix">
											<label>Home Loan Required</label>
								...
								<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
									<form action="#" class="apply_loan_form">
										<h6><i class="fa fa-check-circle"></i> You Are Eligible for Rate Change</h6>
		...
		</div> <!-- End .home_loan_eligibility -->



		<!-- End Home loan Eligibility ___________________ -->
