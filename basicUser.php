<?php 
  ...
  $insertUser = $user->createBasicUser($_POST, $_FILES);
  }
    ...
    <div class="container col-sm-8 col-lg-8 col-md-8 center-block">
        <div class="row" style="padding: 133px; margin:30px; border: 2px solid;">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                ?>
                <input type="hidden" name="package" value="<?php $id = session::get('package_id');?>">
              ...
              <button type="submit" name="addUser" class="btn btn-primary pull-right">Register</button>
        </form>
        </div>
    </div>
<script type="text/javascript">
